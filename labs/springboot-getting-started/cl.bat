@echo off
REM --
REM -- Vytvori studijni sub-projekt tzv. "LAB" - pro overeni dane myslenky. Predpoklada, ze existuje
REM -- adresar na stejne urovni /temp, ktery obsahuje specificke soubory
REM --
REM -- 
...
move %LAB_PATH%\Dockerfile.txt %LAB_PATH%\Dockerfile
